                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Entidad Emisora </h3>
                                    <div class="box-tools">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <?php $articulos = consultas::get_datos("SELECT cod_entidad, entidad_descri, entidad_estado FROM enti_emisora"); 
                                                if (!empty($articulos)) { ?>
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped table-condensed table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="#" class="text-center"><?php echo $articulo['cod_entidad'];?></td>
                                                            <td data-title="Descripcion" class="text-center"><?php echo $articulo['entidad_descri'];?></td>
                                                            <td data-title="estado" class="text-center"><?php echo $articulo['entidad_estado'];?></td>
                                                            <td data-title="Acciones" class="text-center">

                                                            <?php if($articulo['entidad_estado']=='ACTIVO'){?>
                                                                    <a onclick="desactivar(<?php echo "'".$articulo['cod_entidad']."_".$articulo['entidad_descri']."'";?>)" 
                                                                    ...
                                                                    <a href="articulo.editar.php?vcod_entidad=<?php echo $articulo['cod_entidad'];?>" class="btn btn-success btn-sm" data-title="Editar" rel="tooltip" data-placement="left">
                                                                    <i class="fa fa-edit"></i></a>
                                                                    <?php }
                                                                if($articulo['entidad_estado']=='INACTIVO'){?>
                                                                     <a onclick="activar(<?php echo "'".$articulo['cod_entidad']."_".$articulo['entidad_descri']."'";?>)" 
