                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Reporte de Pagina</h3>
                                    <div class="box-tools">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <form action="pagina.print.php" method="get" accept-charset="utf-8" class="form-horizontal">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="pagina.rpt.php?opcion=1" class="list-group-item">Por Codigo</a>
                                                                    <a href="pagina.rpt.php?opcion=2" class="list-group-item">Por Descripcion</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
