                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Reporte de Tipo Impuesto</h3>
                                    <div class="box-tools">
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-md-12 col-xs-12 col-lg-12">
                                            ...
                                            <form action="tipoimpuesto.print.php" method="get" accept-charset="utf-8" class="form-horizontal">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="tipoimpuesto.rpt.php?opcion=1" class="list-group-item">Por Codigo</a>
                                                                    <a href="tipoimpuesto.rpt.php?opcion=2" class="list-group-item">Por Descripcion</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select class="form-control select2" name="vdesde">
                                                                            ...
                                                                            <option value="<?php if ($opcion==='1') {
                                                                                 echo $impu['tipo_cod'];}
                                                                                 else {$impu['tipo_descri'];}
                                                                                ?>">
                                                                                <?php if ($opcion=='1') {
                                                                                        echo $impu['tipo_cod'];} else {
                                                                                        echo $impu['tipo_descri'];
                                                                                        }?>
                                                                            </option>
                                                                             <?php }
                                                                                } ?>
