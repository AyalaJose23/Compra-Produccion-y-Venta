                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-primary"> <!--linea azul-->
                                <div class="box-header">  <!--compo blanco-->
                                    ...
                                    <h3 class="box-title">Reporte de los Proveedores</h3>
                                    <div class="box-tools">
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-md-12 col-xs-12 col-lg-12">
                                            ...
                                            <form action="proveedor.print.php" method="get" accept-charset="utf-8" class="form-horizontal">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="proveedor.rpt.php?opcion=1" class="list-group-item">Por Codigo</a>
                                                                    <a href="proveedor.rpt.php?opcion=2" class="list-group-item">Por Ruc</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
