                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Reporte de Pedidos de Compras</h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            ?>
                                            <form action="pedcompras.print.php" method="get" accept-charset="utf-8" class="form-horizontal" target="print">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="pedcompras.rpt.php?opcion=1" class="list-group-item">Por Fechas</a>
                                                                    <a href="pedcompras.rpt.php?opcion=2" class="list-group-item">Por Proveedor</a>
                                                                    <a href="pedcompras.rpt.php?opcion=3" class="list-group-item">Por Articulo</a>
                                                                    <a href="pedcompras.rpt.php?opcion=4" class="list-group-item">Por Empleado</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label col-lg-2 col-md-2 col-sm-2">Proveedores:</label>
