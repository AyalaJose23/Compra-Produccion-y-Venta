                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Tipo Insumo</h3>
                                    <div class="box-tools">
                                        <a href="tipo_insimo.anadir.php" class="btn btn-primary btn-sm" data-title="Agregar" rel="tooltip" data-placement="left">
                                            <i class="fa fa-plus"></i></a>
                                            <a href="tipo_insimo.print.php" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip" data-placement="left" target="print">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <?php $articulos = consultas::get_datos("SELECT tmp_cod, tmp_descri, tmp_estado FROM tipo_mp"); 
                                                if (!empty($articulos)) { ?>
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped table-condensed table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="Descripción"><?php echo $articulo['tmp_cod'];?></td>
                                                            <td data-title="Tipo de Insumo"><?php echo $articulo['tmp_descri'];?></td>
                                                            <td data-title="Precio Venta"><?php echo $articulo['tmp_estado'];?></td>
                                                            <td data-title="Acciones" class="text-center">

                                                            <?php if($articulo['tmp_estado']=='ACTIVO'){?>
                                                                    <a onclick="desactivar(<?php echo "'".$articulo['tmp_cod']."_".$articulo['tmp_descri']."'";?>)" 
                                                                    ...
                                                                    <a href="articulo.editar.php?vtmp_cod=<?php echo $articulo['tmp_cod'];?>" class="btn btn-success btn-sm" data-title="Editar" rel="tooltip" data-placement="left">
                                                                    <i class="fa fa-edit"></i></a>
                                                                    <?php }
                                                                if($articulo['tmp_estado']=='INACTIVO'){?>
                                                                     <a onclick="activar(<?php echo "'".$articulo['tmp_cod']."_".$articulo['tmp_descri']."'";?>)" 
