                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <?php $articulos = consultas::get_datos("SELECT cod_etapa_p, etapa_descrip_p, etapa_estado_p FROM etapa"); 
                                                if (!empty($articulos)) { ?>
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped table-condensed table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="Descripción"><?php echo $articulo['cod_etapa_p'];?></td>
                                                            <td data-title="Tipo de Insumo"><?php echo $articulo['etapa_descrip_p'];?></td>
                                                            <td data-title="Precio Venta"><?php echo $articulo['etapa_estado_p'];?></td>
                                                            <td data-title="Acciones" class="text-center">

                                                            <?php if($articulo['etapa_estado_p']=='ACTIVO'){?>
                                                                    <a onclick="desactivar(<?php echo "'".$articulo['cod_etapa_p']."_".$articulo['etapa_descrip_p']."'";?>)" 
                                                                    ...
                                                                    <a href="articulo.editar.php?vcod_etapa_p=<?php echo $articulo['cod_etapa_p'];?>" class="btn btn-success btn-sm" data-title="Editar" rel="tooltip" data-placement="left">
                                                                    <i class="fa fa-edit"></i></a>
                                                                    <?php }
                                                                if($articulo['etapa_estado_p']=='INACTIVO'){?>
                                                                     <a onclick="activar(<?php echo "'".$articulo['cod_etapa_p']."_".$articulo['etapa_descrip_p']."'";?>)" 
