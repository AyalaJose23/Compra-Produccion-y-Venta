                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="articulo.anadir.php" class="btn btn-primary btn-sm" data-title="Agregar" rel="tooltip" data-placement="left">
                                            <i class="fa fa-plus"></i></a>
                                            <a href="articulo.print.php" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip" data-placement="left" target="print">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <?php $articulos = consultas::get_datos("select * from v_articulo where (mar_descri||art_descri) ilike '%".(isset($_REQUEST['buscar'])? $_REQUEST['buscar']:"")."%' order by art_cod"); 
                                                if (!empty($articulos)) { ?>
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped table-condensed table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="Descripción"><?php echo $articulo['art_descri'];?></td>
                                                            <td data-title="Tipo de Insumo"><?php echo $articulo['tmp_descri'];?></td>
                                                            <td data-title="Precio Venta"><?php echo $articulo['mar_descri'];?></td>
                                                            <td data-title="Precio Costo"><?php echo $articulo['art_precioc'];?></td>
                                                            <td data-title="Impuesto"><?php echo $articulo['tipo_descri'];?></td>
                                                            <td data-title="Acciones" class="text-center">

                                                            <?php if($articulo['art_estado']=='ACTIVO'){?>
                                                                    <a onclick="desactivar(<?php echo "'".$articulo['art_cod']."_".$articulo['art_descri']."'";?>)" 
                                                                    ...
                                                                    <a href="articulo.editar.php?vart_cod=<?php echo $articulo['art_cod'];?>" class="btn btn-success btn-sm" data-title="Editar" rel="tooltip" data-placement="left">
                                                                    <i class="fa fa-edit"></i></a>
                                                                    <?php }
                                                                if($articulo['art_estado']=='INACTIVO'){?>
                                                                     <a onclick="activar(<?php echo "'".$articulo['art_cod']."_".$articulo['art_descri']."'";?>)" 
