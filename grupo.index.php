                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td data-title="Nombre"><?php echo $gru['gru_nombre'];?></td>
                                                            <td data-title="Acciones" class="text-center">
                                                                <a onclick="editar(<?php echo "'".$gru['gru_cod']."_".$gru['gru_nombre']."'"?>)" 
                                                                ...
                                                                <a onclick="borrar(<?php echo "'".$gru['gru_cod']."_".$gru['gru_nombre']."'"?>)" 
                     ...
                     <div class="modal-dialog">
                         <div class="modal-content">
                             ...
                             <form action="grupo_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                 ...
                                 <input id="cod" name="vgru_cod" type="hidden"/>
                                 <div class="box-body">
                                     <div class="form-group">
                                         <label class="col-sm-2 control-label">Nombre</label>
                                         <div class="col-sm-6 col-lg-6 col-xs-6 col-md-6">
                                             <input id="descri" type="text" class="form-control" name="vgru_nombre" required=""/>
                                         </div>
                                     </div>
                                 </div>
                                 <div class="modal-footer">
