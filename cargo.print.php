...
//COLOR DE TABLA
        ...
        $pdf->SetFillColor(255, 255, 255);
            ...
            if ($_REQUEST['opcion']=='1') {
                $cargos = consultas::get_datos("select * from cargo "
                        . "where car_cod between ".$_REQUEST['vdesde']." and "
                        .$_REQUEST['vhasta']." order by car_cod");
            } else {
               $cargos = consultas::get_datos("select * from cargo "
                        . "where car_descri between '".$_REQUEST['vdesde']."' and '"
                        .$_REQUEST['vhasta']."' order by car_descri");
            }
         } else {
        ...
        foreach ($cargos as $car) {
            $pdf->Cell(50,5,$car['car_cod'], 1, 0, 'C', 1);
            $pdf->Cell(0,5,$car['car_descri'], 1, 0, 'C', 1);
            $pdf->Ln();
        }
