        ...
        if (!empty(isset($_REQUEST['vdesde']))&& !empty(isset($_REQUEST['vhasta']))) {
            if ($_REQUEST['opcion']=='1') {
                $marcas = consultas::get_datos("select * from marca "
                        . "where mar_cod between ".$_REQUEST['vdesde']." and "
                        .$_REQUEST['vhasta']." order by mar_cod");
            } else {
               $marcas = consultas::get_datos("select * from marca "
                        . "where mar_descri between '".$_REQUEST['vdesde']."' and '"
                        .$_REQUEST['vhasta']."' order by mar_descri");
            }
         } else {
            ...
            $pdf->Cell(50,5,$mar['mar_cod'], 1, 0, 'C', 1);
            $pdf->Cell(0,5,$mar['mar_descri'], 1, 0, 'C', 1);
            $pdf->Ln();
        }
