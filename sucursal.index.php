                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td data-title="Descripcion"><?php echo $suc['suc_descri'];?></td>
                                                            <td data-title="Acciones" class="text-center">
                                                                <a onclick="editar(<?php echo "'".$suc['id_sucursal']."_".$suc['suc_descri']."'"?>)" 
                                                                ...
                                                                <a onclick="borrar(<?php echo "'".$suc['id_sucursal']."_".$suc['suc_descri']."'"?>)" 
                     ...
                     <div class="modal-dialog">
                         <div class="modal-content">
                             <div class="modal-header">
                                 ...
                                 <h4 class="modal-title">Registrar Sucursales</h4>
                             </div>
                     ...
                     <div class="modal-dialog">
                         <div class="modal-content">
                             ...
                             <form action="sucursal_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                 ...
                                 <input id="cod" name="vid_sucursal" type="hidden"/>
                                 <div class="box-body">
                                     <div class="form-group">
                                         <label class="col-sm-2 control-label">Descripcion</label>
                                         <div class="col-sm-12 col-lg-12 col-xs-12 col-md-12">
                                             <input id="descri" type="text" class="form-control" name="vsuc_descri" required=""/>
                                         </div>
                                     </div>
                                 </div>
                                 <div class="modal-footer">
