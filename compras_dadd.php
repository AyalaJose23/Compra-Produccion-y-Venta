...
$detalles = consultas::get_datos("select * from v_detalle_ordens where orden_cod =(select max(orden_cod)from v_detalle_ordens)"." and art_cod =".$_REQUEST['vart_cod']);
...
<div class="modal-header">
    ...
    <h4 class="modal-title"><i class="fa fa-plus"></i> <strong>Agregar Detalle de Compra</strong></h4>
</div>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-3 col-sm-3 col-md-3">
                <input type="number" name="vcom_cant" class="form-control" min="1" required="" value="<?php echo $detalles[0]['orden_cant']?>"/>
            </div>
        </div> 
        <div class="form-group">
            <label class="control-label col-lg-2 col-sm-2 col-md-2">Precio:</label>
            <div class="col-lg-4 col-sm-4 col-md-4">
                <input type="number" name="vcom_precio" class="form-control" min="1" required="" value="<?php echo $detalles[0]['orden_precio']?>"/>
            </div>
        </div>         
    </div>
