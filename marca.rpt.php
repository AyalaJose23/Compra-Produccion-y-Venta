                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-md-12 col-xs-12 col-lg-12">
                                            ...
                                            <form action="marca.print.php" method="get" accept-charset="utf-8" class="form-horizontal">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="marca.rpt.php?opcion=1" class="list-group-item">Por Codigo</a>
                                                                    <a href="marca.rpt.php?opcion=2" class="list-group-item">Por Descripcion</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
