    ...
    <body class="hold-transition skin-black sidebar-mini">
                        ...
                        <div class="col-lg-12 col-xs-12 col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Pedido de Materia Prima</h3>
                                    <div class="box-tools">
                                        <a href="pedmp.anadir.php" class="btn btn-primary btn-sm" data-title="Agregar" rel="tooltip" data-placement="left">
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            ...
                                            <?php
                                             $pedidos = consultas::get_datos("select * from v_pedido_mp where (ped_mp::varchar||ped_fecha::varchar) ilike '%".(isset($_REQUEST['buscar'])? $_REQUEST['buscar']:"")."%' order by ped_mp desc"); 
                                             if (!empty($pedidos)) { ?>
                                                ...
                                                <table class="table col-lg-12 col-md-12 col-xs-12 table-bordered table-striped table-condensed">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($pedidos as $pedido) { ?>
                                                             <tr>
                                                        <td data-title="#"><?php echo $pedido['ped_mp'];?></td>
                                                        ...
                                                        <td data-title="Acciones" class="text-center">
                                                                ...
                                                                <a href="pedmp.det.php?vped_mp=<?php echo $pedido['ped_mp'];?>" 
                                                                   class="btn btn-primary btn-sm" data-title="Detalles" rel="tooltip" data-placement="top">
                                                                    <i class="fa fa-list"></i></a>
                                                                
                                                                <!-- a href="pedmps.editar.php?vped_mp=<--?php echo $pedido['ped_mp'];?>" class="btn btn-success btn-sm" data-title="Editar" rel="tooltip" data-placement="left">
                                                                    <i class="fa fa-edit"></i></a-->
                                                                    <a onclick="anular(<?php echo "'".$pedido['ped_mp']."_".$pedido['ped_fecha']."'";?>)" 
                                                                       class="btn btn-danger btn-sm" data-title="Anular" rel="tooltip" data-placement="left" data-toggle="modal" data-target="#anular">
                                                                    <i class="fa fa-remove"></i></a>
                                                                    
                                                                <?php }?> 
                                                                <a href="pedmp.print.php?vped_mp=<?php echo $pedido['ped_mp'];?>" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip" data-placement="left" target="_blank">
        ...
        <script>
          /*  function editar(datos) {
            ...
            var dat = datos.split('_');
            $('#si').attr('href','pedmp_control.php?vped_mp='+dat[0]+'&accion=3');
            $("#confirmacion").html('<span class="glyphicon glyphicon-warning-sign"></span> \n\
            Desea anular el Pedido N° <strong>'+dat[0]+'</strong> de fecha <strong>'+dat[1]+'</strong>')
        }
        function confirmar(datos){
            var dat = datos.split('_');
            $('#sic').attr('href','pedmp_control.php?vped_mp='+dat[0]+'&accion=2');
