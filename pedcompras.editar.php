                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Editar Pedido Compras</h3>
                                    <div class="box-tools">
                                        <a href="pedcompras.index.php" class="btn btn-primary btn-sm" data-title="Volver" rel="tooltip">
                                            <i class="fa fa-arrow-left"></i> VOLVER</a>
                                    </div>
                                </div>
                                <form action="pedcompras_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                    <?php $pedidos = consultas::get_datos("select * FROM v_pedido_cabcompra WHERE ped_com = ( select max(ped_com) from v_pedido_cabcompra)");?>
