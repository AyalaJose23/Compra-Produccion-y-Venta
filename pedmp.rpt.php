                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Reporte de Pedidos de Materia Prima</h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            ?>
                                            <form action="pedmp.print.php" method="get" accept-charset="utf-8" class="form-horizontal" target="print">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="pedmp.rpt.php?opcion=1" class="list-group-item">Por Fechas</a>
                                                                    <a href="pedmp.rpt.php?opcion=2" class="list-group-item">Por Articulo</a>
                                                                    <a href="pedmp.rpt.php?opcion=3" class="list-group-item">Por Empleado</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    case 2:
                                                                    $articulos = consultas::get_datos("select * from v_articulo where art_cod in(select art_cod from detalle_pedmp)");
                                                                ?>
                                                                ...
                                                                <?php  
                                                                    break;
                                                                    case 3:
                                                                    $empleados = consultas::get_datos("select * from empleado where emp_cod in(select emp_cod from pedido_mp)");
                                                                ?>
                                                                <div class="form-group">
