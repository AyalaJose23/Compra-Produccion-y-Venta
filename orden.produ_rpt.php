...
<head>
        ...
        <title>Todo Muebles - Orden de Produccion</title>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Reporte de Orden de Produccion</h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="orden.produ_rpt.php?opcion=1" class="list-group-item">Por Fechas</a>
                                                                    <a href="orden.produ_rpt.php?opcion=2" class="list-group-item">Por Cliente</a>
                                                                    <a href="orden.produ_rpt.php?opcion=3" class="list-group-item">Por Producto</a>
                                                                    <a href="orden.produ_rpt.php?opcion=4" class="list-group-item">Por Empleado</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <?php
                                                                    break;
                                                                    case 2:
                                                                    $clientes = consultas::get_datos("select * from clientes where cli_cod in(select cli_cod from orden_produ)");
                                                                ?>
                                                                ...
                                                                <?php  
                                                                    break;                                                                
                                                                    case 3:
                                                                    $producto = consultas::get_datos("select * from v_producto where cod_produ in(select cod_produ from detalle_orden_prod)");
                                                                ?>
                                                                <div class="form-group">
                                                                ...
                                                                <?php  
                                                                    break;
                                                                    case 4:
                                                                    $empleados = consultas::get_datos("select * from empleado where emp_cod in(select emp_cod from orden_produ)");
                                                                ?>
                                                                <div class="form-group">
