...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="/tdp/menu.php"><span class="glyphicon glyphicon-home"></span> <strong>Inicio</strong></a></li>
...
order by pag_nombre");        
 ...
 <?php } ?>  
 <li><a href="/tdp/MANUAL DE USUARIO tdp.pdf" target="print"><span class="glyphicon glyphicon-question-sign"></span> <strong>Ayuda</strong></a></li>          
        </ul>
    </section>
    <!-- /.sidebar -->
</aside>