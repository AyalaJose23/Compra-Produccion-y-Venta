                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="deposito.anadir.php" class="btn btn-primary btn-sm" data-title="Agregar" rel="tooltip" data-placement="left">
                                            <i class="fa fa-plus"></i></a>
                                            <a href="deposito.print.php" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip" data-placement="left" target="print">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <?php $depositos = consultas::get_datos("select * from v_deposito where (dep_descri||suc_descri) ilike '%".(isset($_REQUEST['buscar'])? $_REQUEST['buscar']:"")."%' order by dep_cod"); 
                                                if (!empty($depositos)) { ?>
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped table-condensed table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="Descripción"><?php echo $depo['dep_descri']." ".$depo['suc_descri'];?></td>
                                                         <!--   <td data-title="Precio Costo"></?php echo $depo['art_precioc'];?></td>
                                                            <td data-title="Precio Venta"></?php echo $depo['art_preciov'];?></td>
                                                            <td data-title="Impuesto"></?php echo $depo['tipo_descri'];?></td>-->
                                                            <td data-title="Acciones" class="text-center">
                                                                <a href="deposito.editar.php?vdep_cod=<?php echo $depo['dep_cod'];?>" class="btn btn-warning btn-sm" data-title="Editar" rel="tooltip" data-placement="left">
                                                                    <i class="fa fa-edit"></i></a>  
                                                                <a onclick="borrar(<?php echo "'".$depo['dep_cod']."_".$depo['dep_descri']."_".$depo['suc_descri']."'"?>)" 
