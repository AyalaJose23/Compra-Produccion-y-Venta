                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        ...
                                        <a href="sucursal.print.php" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip" data-placement="left" target="print">
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-md-12 col-xs-12 col-lg-12">
                                            ...
                                            <form action="sucursal.print.php" method="get" accept-charset="utf-8" class="form-horizontal">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="sucursal.rpt.php?opcion=1" class="list-group-item">Por Codigo</a>
                                                                    <a href="sucursal.rpt.php?opcion=2" class="list-group-item">Por Descripcion</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select class="form-control select2" name="vdesde">
                                                                            ...
                                                                            <option value="<?php if ($opcion==='1') {
                                                                                 echo $suc['id_sucursal'];}
                                                                                 else {$suc['suc_descri'];}
                                                                                ?>">
                                                                                <?php if ($opcion=='1') {
                                                                                        echo $suc['id_sucursal'];} else {
                                                                                        echo $suc['suc_descri'];
                                                                                        }?>
                                                                            </option>
                                                                             <?php }
