...
session_start();
//$detalles = consultas::get_datos("select * from v_detalle_pedcompra where ped_com=".$_REQUEST['vped_com']." and art_cod =".$_REQUEST['vart_cod']);
?>
<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">x</button>
    <h4 class="modal-title"><i class="fa fa-plus"></i> <strong>Agregar Detalle de Presupuesto</strong></h4>
</div>
