                        ...
                        <div class="col-lg-12 col-xs-12 col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="ventas.anadir.php" class="btn btn-primary btn-sm" data-title="Agregar" rel="tooltip" data-placement="left">
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            ...
                                            <?php
                                            $ventas = consultas::get_datos("SELECT * FROM v_ventas WHERE (ven_cod::VARCHAR || ven_fecha::VARCHAR) ILIKE '%" . (isset($_REQUEST['buscar']) ? $_REQUEST['buscar'] : "") . "%' ORDER BY ven_cod DESC");
                                            if (!empty($ventas)) { ?>
                                                        ...
                                                        <td data-title="Estado"><?php echo $venta['ven_estado'];?></td>
                                                            <td data-title="Acciones" class="text-center">
                                                               <?php if($venta['ven_estado']=='PENDIENTE'){?>
                                                                    ...
                                                                    <a href="ventas.det.php?vven_cod=<?php echo $venta['ven_cod'];?>" class="btn btn-primary btn-sm" data-title="Detalles" rel="tooltip" data-placement="left">
