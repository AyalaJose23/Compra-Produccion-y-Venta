...
<form action="ventas_dcontrol.php" method="post" accept-charset="utf-8" class="form-horizontal">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6 col-lg-6 col-xs-6 col-md-6">
                <input type="number" name="vven_cant" class="form-control" min="1" required="" value="<?php echo $detalles[0]['ven_cant']?>"/>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">Precio:</label>
            <div class="col-sm-6 col-lg-6 col-xs-6 col-md-6">
                <input type="number" name="vven_precio" class="form-control" min="1" required="" value="<?php echo $detalles[0]['ven_precio']?>"/>
            </div>
        </div>
    </div>
