...
<div class="modal-header">
    ...
    <h4 class="modal-title"><i class="fa fa-plus"></i> <strong>Agregar Detalle de Venta</strong></h4>
</div>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-3 col-sm-3 col-md-3">
                <input type="number" name="vven_cant" class="form-control" min="1" required="" value="<?php echo $detalles[0]['ped_cant']?>"/>
            </div>
        </div> 
        <div class="form-group">
            <label class="control-label col-lg-2 col-sm-2 col-md-2">Precio:</label>
            <div class="col-lg-4 col-sm-4 col-md-4">
                <input type="number" name="vven_precio" class="form-control" min="1" required="" value="<?php echo $detalles[0]['ped_precio']?>"/>
            </div>
        </div>         
    </div>
