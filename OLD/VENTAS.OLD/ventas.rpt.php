                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            ?>
                                            <form action="ventas.print.php" method="get" accept-charset="utf-8" class="form-horizontal" target="print">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    ...
                                                                    <a href="ventas.rpt.php?opcion=3" class="list-group-item">Por Articulo</a>
