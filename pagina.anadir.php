                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="pagina.index.php" class="btn btn-primary btn-sm" data-title="Volver" rel="tooltip">
                                ...
                                <form action="pagina_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <input type="text" class="form-control" name="vpag_nombre" required="" autofocus=""/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-md-2 col-sm-2">Direccion:</label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <input type="text" class="form-control" name="vpag_direc" required=""/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <?php $modulos = consultas::get_datos("select * from modulos order by mod_nombre");?>
                                            <label class="control-label col-lg-2 col-md-2 col-sm-2">Modulo:</label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary pull-right" data-title="Guardar Datps" rel="tooltip">
                                            <i class="fa fa-floppy-o"> Guardar</i></button>
                                    </div>
                                </form>
                            </div>
                        </div>
