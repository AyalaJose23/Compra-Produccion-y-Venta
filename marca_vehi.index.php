                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Marca de Vehiculo</h3>
                                    <div class="box-tools">
                                        <a href="procesos.anadir.php" class="btn btn-primary btn-sm" data-title="Agregar" rel="tooltip" data-placement="left">
                                            <i class="fa fa-plus"></i></a>
                                            <a href="procesos.print.php" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip" data-placement="left" target="print">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <?php $articulos = consultas::get_datos("SELECT cod_mar_vehi, descrip_mar_vehi, marca_vhi_estado FROM marca_vehiculo"); 
                                                if (!empty($articulos)) { ?>
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped table-condensed table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="#" class="text-center"><?php echo $articulo['cod_mar_vehi'];?></td>
                                                            <td data-title="Descripcion" class="text-center"><?php echo $articulo['descrip_mar_vehi'];?></td>
                                                            <td data-title="estado" class="text-center"><?php echo $articulo['marca_vhi_estado'];?></td>
                                                            <td data-title="Acciones" class="text-center">

                                                            <?php if($articulo['marca_vhi_estado']=='ACTIVO'){?>
                                                                    <a onclick="desactivar(<?php echo "'".$articulo['cod_mar_vehi']."_".$articulo['descrip_mar_vehi']."'";?>)" 
                                                                    ...
                                                                    <a href="articulo.editar.php?vcod_mar_vehi=<?php echo $articulo['cod_mar_vehi'];?>" class="btn btn-success btn-sm" data-title="Editar" rel="tooltip" data-placement="left">
                                                                    <i class="fa fa-edit"></i></a>
                                                                    <?php }
                                                                if($articulo['marca_vhi_estado']=='INACTIVO'){?>
                                                                     <a onclick="activar(<?php echo "'".$articulo['cod_mar_vehi']."_".$articulo['descrip_mar_vehi']."'";?>)" 
