                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="stock.anadir.php" class="btn btn-primary btn-sm" data-title="Agregar" rel="tooltip" data-placement="left">
                                            <i class="fa fa-plus"></i></a>
                                            <a href="stock.print.php" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip" data-placement="left" target="print">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <?php $stocks = consultas::get_datos("select * from v_stock where art_descri ilike '%".(isset($_REQUEST['buscar'])? $_REQUEST['buscar']:"")."%' order by art_descri"); 
                                                if (!empty($stocks)) { ?>
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped table-condensed table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="ARTICULO"><?php echo $stock['art_descri'];?></td>
                                                            <td data-title="CANT.MAXIMA"><?php echo $stock['stoc_cant'];?></td>
                                            ...
                                            <div class="alert alert-info">
                                                ...
                                                No existe stocks de algun producto...
                                            </div>      
                                            <?php } ?>
                                        </div>
                                    </div>
       ...
       <script>
            ...
            function borrar(datos) {
                ...
                $('#confirmacion').html('<span class="glyphicon glyphicon-warning-sign"></span> \n\
                                Desea borrar el articulo <i><strong>'+dat[3]+" "+dat[1]+'</strong> ?</i>');
            }
        </script>
    </body>
</html>
