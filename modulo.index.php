    ...
    <body class="hold-transition skin-blue sidebar-mini">
                                                ...
                                                <table class="table col-lg-12 col-md-12 col-xs-12 table-bordered table-striped table-condensed">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($modulos as $mod) { ?>
                                                             <tr>
                                                        <td data-title="Descripcion"><?php echo $mod['mod_nombre'];?></td>
                                                            <td data-title="Acciones" class="text-center">
                                                                <a onclick="editar(<?php echo "'".$mod['mod_cod']."_".$mod['mod_nombre']."'"?>)" 
                                                                ...
                                                                <a onclick="borrar(<?php echo "'".$mod['mod_cod']."_".$mod['mod_nombre']."'"?>)" 
                 ...
                 <div class="modal fade" id="registrar" role="dialog">
                     <div class="modal-dialog">
                         <div class="modal-content">
                             ...
                             <form action="modulo.control.php" method="post" accept-charset="utf-8" class="form-horizontal">
        ...
        <script>
            ...
            function borrar(datos) {
                var dat = datos.split("_");
                $('#si').attr('href','modulo.control.php?vmod_cod='+dat[0]+'&vmod_nombre='+dat[1]+'&accion=3');
